...
const Shop=({x,y,w,h,className='',children})=><g className={`district-shop ${className}`} transform={`translate(${x} ${y})`}>
  ...
  <rect className="district-window" x="16" y="62" width={Math.max(34,w*.42)} height={Math.max(42,h-78)} rx="2"/>
  <rect className="district-door" x={w-48} y="62" width="32" height={Math.max(52,h-62)}/>
  {children}
 </g>;
...
function OctopusInstitution(){
  return <g className="octopus-institution" transform="translate(1110 545)">
    <path className="octopus-canopy" d="M0 42L30 0H270L300 42Z"/>
    <rect className="octopus-board" x="34" y="46" width="232" height="92" rx="3"/>
    <path className="octopus-orders" d="M54 66h74M54 84h116M54 102h92M168 66h74M178 102h64M54 120h188"/>
    <path className="octopus-counter" d="M20 154h260M36 154v34M264 154v34"/>
    <g className="octopus-mark" transform="translate(244 22)">
      <path d="M-24 15q0-25 24-25t24 25q0 15-8 23M-15 34q-15 23-27 3M-5 36q-6 28-19 25M5 36q6 28 19 25M15 34q15 23 27 3"/>
    </g>
    <g className="octopus-payments" transform="translate(70 143)"><rect x="-26" y="-42" width="52" height="38" rx="3"/><path d="M-16-29h32M-16-18h20"/></g>
  </g>;
}

function FestivalStage({active}){
  return <g className={`festival-stage ${active?'active':'quiet'}`} transform="translate(820 850)">
    <path className="festival-platform" d="M0 74H250L232 108H18Z"/>
    <path className="festival-rig" d="M18 74V0H232V74M18 16h214"/>
    <circle className="festival-light" cx="52" cy="16" r="7"/><circle className="festival-light" cx="125" cy="16" r="7"/><circle className="festival-light" cx="198" cy="16" r="7"/>
    <path className="festival-speaker" d="M26 42h28v32H26ZM196 42h28v32h-28Z"/>
    <path className="festival-mic" d="M125 74V38m0 0l12-10"/>
  </g>;
}
...
export function HarbourDistrictBase({world}) {
  ...
  return <g aria-hidden="true" pointerEvents="none" className={`harbour-district sea-${state.seaEnergy} ${state.commercialQuiet?'district-quiet':''} ${state.cinemaNight?'cinema-night':''}`}>
    ...
    <g className="district-social-quarter">
      ...
      <Shop x={920} y={315} w={150} h={160} className="pizza-shop"><path className="pizza-slice" d="M30 76l44 9l-31 49Z"/><circle cx="49" cy="98" r="4"/><circle cx="58" cy="111" r="4"/></Shop>
      <Shop x={1090} y={320} w={155} h={160} className="deli-shop"><path className="deli-shelves" d="M28 86h72M28 108h72M28 130h72"/><path className="deli-jar" d="M38 72v-18h18v18M68 72v-24h20v24"/></Shop>
    </g>
    ...
    <g className="district-gameplay-institutions">
      ...
      <Shop x={500} y={250} w={245} h={168} className="sonya-kitchen"><rect className="kitchen-stove" x="30" y="94" width="62" height="50"/><circle cx="45" cy="104" r="7"/><circle cx="73" cy="104" r="7"/><rect className="kitchen-table" x="112" y="112" width="70" height="28"/><path className="kitchen-pans" d="M116 70q12-18 24 0M150 70q12-18 24 0"/></Shop>

      <g className="nursery-garden" transform="translate(440 590)"><path className="nursery-wall" d="M0 120V22H230V120"/><path className="nursery-shade" d="M-10 30Q110-20 240 30"/><rect className="nursery-bed" x="12" y="72" width="80" height="38"/><rect className="nursery-bed" x="108" y="64" width="102" height="46"/>{[28,52,76,126,150,178,198].map((x,i)=><path key={x} className="nursery-plant" d={`M${x} ${96-(i%2)*8}v-26m0 12q-12-10-16-2m16-4q12-12 17-3`}/>) }<ellipse className="toad-basin" cx="214" cy="116" rx="28" ry="10"/></g>

      <g className="old-cinema" transform="translate(305 620)"><rect className="cinema-shell" width="250" height="168" rx="4"/><rect className="cinema-marquee" x="18" y="18" width="214" height="38"/><rect className="cinema-screen" x="34" y="72" width="120" height="70"/><path className="cinema-seats" d="M174 86h46M174 102h46M174 118h46M174 134h46"/><path className="film-reel" d="M62 107a16 16 0 1 0 32 0a16 16 0 1 0-32 0M102 107a16 16 0 1 0 32 0a16 16 0 1 0-32 0"/></g>

      <OctopusInstitution/>

      <g className="dima-apartments" transform="translate(1730 455)"><rect className="apartment-shell" width="220" height="232"/><path className="apartment-roof" d="M-8 0h236l-22-28H14Z"/>{[24,82,140].map(x=><g key={x}><rect className="apartment-window" x={x} y="38" width="36" height="38"/><rect className="apartment-window" x={x} y="98" width="36" height="38"/></g>)}<path className="apartment-balconies" d="M12 84h190M12 144h190M30 84v12M88 84v12M146 84v12M188 84v12M30 144v12M88 144v12M146 144v12M188 144v12"/><rect className="apartment-door" x="88" y="166" width="46" height="66"/><path className="apartment-stairs" d="M144 226h54M154 216h44M164 206h34"/></g>
    </g>

    <g className="district-park" transform="translate(440 730)"><path className="park-grass" d="M0 24Q200-36 470 14L520 210Q254 286 22 192Z"/><g className="basketball-court" transform="translate(210 46)"><rect width="250" height="138" rx="4"/><path d="M125 0v138M0 69h250M45 0v138M205 0v138"/><path d="M34 28v56h22M216 28v56h-22"/></g><g className="chess-tables" transform="translate(40 62)"><rect x="0" y="0" width="58" height="34"/><rect x="74" y="20" width="58" height="34"/><path d="M8 8h42M8 17h42M8 26h42M16 0v34M29 0v34M42 0v34"/></g><path className="park-path" d="M18 170q185-90 440-32"/></g>

    <FestivalStage active={state.festivalDay}/>

    <g className="district-berth"><path className="dock-edge" d="M940 650q260 30 530-10q170-26 322-100"/><g className="cargo-stack" transform="translate(1190 650)"><rect x="0" y="0" width="62" height="48"/><rect x="68" y="-18" width="72" height="66"/><rect x="146" y="8" width="56" height="40"/><path d="M0 24h62M99-18v66M146 28h56"/></g><g className="small-boat" transform="translate(1515 840)"><path d="M-100 0H96L68 58H-66Z"/><path d="M-20 0v-74h68v74"/><path d="M-8-60h42v38H-8Z"/></g><path className="mooring-rope" d="M1418 724q105 98 214 50"/></g>

    <g className="street-furniture"><g className="trash-bin" transform="translate(1840 575)"><rect x="-20" y="-20" width="40" height="46" rx="4"/><path d="M-24-20h48M-12-30h24"/></g><g className="bench" transform="translate(710 965)"><path d="M-48 0h96M-42 12h84M-36 12v20M36 12v20"/></g><g className="street-light" transform="translate(1080 610)"><path d="M0 70V-54q0-20 22-20h22"/><rect x="36" y="-82" width="34" height="18" rx="4"/></g><path className="laundry-line" d="M1480 286q122-30 244 0"/><path className="laundry" d="M1510 279v46h40v-54M1580 267v52h44v-60M1652 260v45h38v-51"/></g>
...
export function DistrictOccluder({item}) {
  ...
  if(item.kind==='nursery-fence') return <g className="district-occluder nursery-fence" transform={`translate(${x} ${y})`}><path d={`M${-w/2} 0H${w/2}M${-w/2} ${-h}H${w/2}`}/>{[-.4,-.2,0,.2,.4].map(n=><path key={n} d={`M${n*w} 0V${-h}`}/>)}</g>;
  if(item.kind==='gallery-rope') return <g className="district-occluder gallery-rope" transform={`translate(${x} ${y})`}><path d={`M${-w/2} 0H${w/2}M${-w/2} 0V${-h}M${w/2} 0V${-h}`}/></g>;
...
export function HarbourWeatherOverlay({world}) {
  ...
  return <g aria-hidden="true" pointerEvents="none" className="weather-overlay storm-overlay"><rect width={HARBOUR_WORLD.width} height={HARBOUR_WORLD.height}/>{Array.from({length:76},(_,i)=><path key={i} d={`M${(i*83)%2020} ${(i*137)%1120}l-22 52`}/>)}</g>;
}
