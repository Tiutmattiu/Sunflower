...
export const NPC_PROFILES = {
  dog: {
    ...
    cashPreference: 0.35,
    goals: [
      { item: "Fresh Mackerel", utility: 4, reason: "Food disappears quickly around the cats." },
      { item: "Fish Bones", utility: 3, reason: "Even scraps have a use at the dock." },
    ],
  ...
  fishmonger: {
    ...
    cashPreference: 0.7,
    goals: [
      { item: "Dead Pigeon", utility: 4, reason: "The fish stall has a strange standing use for it." },
    ],
  ...
  mechanic: {
    ...
    departureDay: 8,
    goals: [
      { item: "Lime Crate", utility: 7, urgencyPerDay: 1.3, reason: "The ship must provision citrus before departure." },
    ],
  ...
  vale: {
    ...
    cashPreference: 0.45,
    goals: [
      { item: "Sperm Whale Oil", utility: 9, reason: "A private screening needs an obsolete fuel." },
      { item: "Blue Glass Marble", utility: 4, reason: "Vale notices objects with story and scarcity." },
    ],
  ...
  clown: {
    ...
    cashPreference: 0.15,
    goals: [
      { item: "Mai Tai", utility: 8, reason: "Clown will pay irrational-looking prices for the right drink and the right night." },
      { item: "Built Onewheel", utility: 7, reason: "A working onewheel creates wagers other people cannot take." },
    ],
  ...
  bar: {
    ...
    cashPreference: 0.25,
    goals: [
      { item: "Orgeat Bottle", utility: 8, reason: "The bar cannot make a proper Mai Tai without it." },
      { item: "Lime Crate", utility: 5, reason: "Fresh citrus is both an input and a rarity." },
    ],
