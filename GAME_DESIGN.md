...
> **Economic activity sustains your options.**
>
...
This is not a survival game: no mandatory daily subsistence drain, compulsory job storyline or automatic rescue is established. Cash and economic activity sustain available choices; waiting can lose opportunities through other actors, deadlines and changing conditions. Information improves decisions and timing. Relationships create credit, access and recovery paths. Exceptional wealth belongs to scarce situations that require the earlier layers rather than replacing them.
...
3. **Continuous attention/time pays for intervention.** Explore through locations; follow known events directly into their actual place or communication scene. Seeking new information, investigation, appointments, labour, negotiation and performance use scarce time/attention. Before commitment, show known costs, deadlines and binding effects. Spotting and collecting a hidden scene toad is an explicit no-attention exception; travel and social participation retain their costs (NPC_CHARACTER_BIBLE §11). Budget and clock units remain Open. Repeated navigation, exhausted dialogue and mandatory phase-by-phase clicking must not manufacture choice.
...
9. **Economy has sources, uses and renewed needs.** Procurement feeds consumption, service or production and subsequent demand. Bar revenue needs actual customers, inputs and finite capacity; finance needs an underlying purpose, payer and loss bearer. Prioritise repeatable named NPC↔player economic loops and named NPC interdependence first. Anonymous households, crews, visitors and suppliers complete bounded demand/supply gaps after those loops work; they must not mask missing named counterparties or provide guaranteed profitable exits. External arrivals, receipts and spending need bounded causes; no unlimited stock, unaccounted cash creation or guaranteed-margin fallback.
...
| Dima | Seagull black-market / informal broker: proxy, guarantees, access, claim transfer, settlement and enforcement | trust/network limits; **strong candidate** costly distressed workout, never a free bailout |
...
**Accepted creator clarification, 2026-09-08; design requirement, not runtime verification.** Joel is the relationship and invitation contact. The player supplies/sells the missing Mai Tai ingredient (the incumbent authored anchor is Orgeat), then builds the relationship through meaningful Bar patronage to a qualifying spend or concrete help, with Joel's trust almost full. Supplying the ingredient alone, spending alone or repeating empty conversation does not earn the invitation. Exact spend/trust values remain Open and should be communicated through scene evidence rather than a visible quest checklist.

Joel invites the player to supper with his grandmother and asks them to bring a particular rare fresh fish, unavailable through ordinary shop purchase. Finding a credible source, obtaining it and arriving with it still fresh are real requirements; ordinary fish, generic food or contributed labour cannot substitute. Species, exceptional sourcing paths, freshness threshold and appointment timing remain Open; no universal fish seller is assigned. Follow the existing Mai Tai recipe and tool ontology in `ITEM_ECONOMY.md`.

Sonya waits for the fish, prepares supper and gives the household Sunflower. She is a supporting presence, not an independently selectable conversation, trading, work or relationship-grinding target. The fish is a supper obligation within an earned relationship, not a posted price for the flower. Joel's routine fish purchases remain discovery clues, not proof that the rare invitation fish is ordinary Mackerel. Supper keeps its non-market allocation identity.
...
## 18. Creator clarification — access and specialization (2026-09-08)

Accepted design direction, not a claim that the current engine implements it:

- Public venues can restrict or ban the player for discovered payment, delivery or representation failures. Venue access, reliability dimensions and personal trust remain separate; no universal reputation cutoff is selected.
- Deceptive or criminal play is possible. Exclusion makes Dima's black-market network the relevant trading route, with finite counterparties, fees, trust, liquidity and possible refusal. A ban is consequential without being an automatic end of the run.
- Reputation can be rebuilt through observable repair, restitution and subsequent reliable performance. Fictional laundering or bribery through an actually available channel may circumvent restrictions; neither erases history nor guarantees immunity. Discovery and repeated misconduct can escalate sanctions up to imprisonment. Thresholds, detection, duration, appeal/re-entry and jail play/end conditions remain Open. This is not species-based exclusion.
- Players should be able to specialise their income in any one of the six return classes without compulsory diversification. Necessary sourcing, collection, transport, relationship work and a Sunflower route are still real prerequisites; specialisation does not mean never buying anything or attending a scene. It guarantees neither profit nor equal wealth, and no arbitrary activity is promised viable at any scale. Chapter 34 of `DESIGN_WORKBOOK.md` owns the viability questions and acceptance cases.
- Ordinary death may end a run; do not add obligatory work, rescue or reincarnation to avoid it. Actual death conditions remain Open. Acquisition still leads to `You got it.` then `Go home`; exact home closure remains Open. The newly requested plant-only alternative is a proposal in workbook Chapter 34, not a change to §5 or reinstatement of retired architecture.
