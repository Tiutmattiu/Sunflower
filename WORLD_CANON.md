...
Sunflower is not a trading game that later turns into a mystery game or spiritual game.
...
Do not expose Entanglement, karma, or enlightenment meters, and do not reward a `[LET GO]` answer.
...
## 9. Primary character directions
...
Material constraints remain real: fish spoils, ice melts, collateral must be realisable, seeds require conditions to grow.
...
The exchange grammar can expand until nearly everything becomes legible as a tradable position: goods, information, exclusivity, obligations, claims, access, relationships, future production, identity and persons.
...
The coverage list in `SCENARIOS_TEACHING.md` is a set of **trading/teaching domains**, not families, factions, quests or world ontology.
...
Repeated objects can include receipts, claims, seeds, fish, toads, timetables, provenance cards and sunflower.
...
## 23. Retired historical hypotheses
